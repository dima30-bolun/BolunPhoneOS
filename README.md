...
- **C kernel API** in `src/kernel/c/` for boot, shutdown, app registry, launch, notifications, contacts, messaging, device profiles, the Bolun Phone 1.0 feature manifest, and Dima30 Store removed-app policy.
